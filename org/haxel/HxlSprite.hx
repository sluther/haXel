...
class HxlSprite extends HxlObject
{
	...
	*/
	 ...
	 */
	public function loadGraphic(Graphic:Class<Bitmap>,Animated:Bool=false,Reverse:Bool=false,Width:UInt=0,Height:UInt=0,Unique:Bool=false):HxlSprite
	{
		_bakedRotation = 0;
	 ...
	 * @return	This HxlSprite instance (nice for chaining stuff together, if you're into that).
	 */
	public function loadRotatedGraphic(Graphic:Class<Bitmap>, Rotations:UInt=16, Frame:Int=-1, AntiAliasing:Bool=false, AutoBuffer:Bool=false):HxlSprite
	{
	...
	public function replaceColor(Color:UInt,NewColor:UInt,FetchPositions:Bool=false):Array<HxlPoint>
	{
