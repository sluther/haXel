package org.haxel;	
	/**
	 * This is a useful "generic" Haxel object.
	 * Both <code>HxlObject</code> and <code>HxlGroup</code> extend this class,
	...
	class HxlBasic
	{
		...
		public var ID:Int;
		/**
		 * Controls whether <code>update()</code> and <code>draw()</code> are automatically called by HxlState/HxlGroup.
		 */
		public var exists:Bool;
		/**
		 * Controls whether <code>update()</code> is automatically called by HxlState/HxlGroup.
		 */
		public var active:Bool;
		/**
		 * Controls whether <code>draw()</code> is automatically called by HxlState/HxlGroup.
		 */
		 ...
		 * In practice, this function is most often called by <code>HxlObject.reset()</code>.
		 */
		...
		{
			return HxlU.getClassName(this,true);
		}
	}
