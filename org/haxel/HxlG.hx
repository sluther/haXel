	...
	class HxlG
	{
		...
		public static function log(Data:Object):Void
		{
			if((_game != null) && (_game._debugger != null))
				_game._debugger.log.add((Data == null)?"ERROR: null object":((Data is Array)?HxlU.formatArray(Data as Array):Data.toString()));
		}
		 ...
		 */
		public static function get framerate():Float
		{
		 ...
		 * @private
		 */
		public static function set framerate(Framerate:Float):Void
		{
		 ...
		 * NOTE: This is NOT the same thing as the Flash Player framerate!
		 */
		public static function get flashFramerate():Float
		{
			if(_game.root != null)
		 ...
		 * @private
		 */
		public static function set flashFramerate(Framerate:Float):Void
		{
		 ...
		 */
		public static function loadReplay(Data:String,State:HxlState=null,CancelKeys:Array=null,Timeout:Float=0,Callback:Function=null):Void
		{
		...
		{
			_game._requestedState = new (HxlU.getClass(HxlU.getClassName(_game._state,false)))();
		}
		 ...
		 */
		public static function playMusic(Music:Class,Volume:Float=1.0):Void
		{
			if(music == null)
				music = new HxlSound();
		 ...
		 */
		public static function loadSound(EmbeddedSound:Class=null,Volume:Float=1.0,Looped:Bool=false,AutoDestroy:Bool=false,AutoPlay:Bool=false,URL:String=null):HxlSound
		{
			...
			var sound:HxlSound = sounds.recycle(HxlSound) as HxlSound;
		 ...
		 * @return	A <code>HxlSound</code> object.
		 */
		public static function play(EmbeddedSound:Class,Volume:Float=1.0,Looped:Bool=false,AutoDestroy:Bool=true):HxlSound
		{
		 ...
		 * @default 0.5
		 */
		 public static function get volume():Float
		 {
			 return _volume;
		 }
		 ...
		 * @private
		 */
		public static function set volume(Volume:Float):Void
		{
			_volume = Volume;
			if(_volume < 0)
				_volume = 0;
		...
		public static function destroySounds(ForceDestroy:Bool=false):Void
		{
			...
			while(i < l)
			{
				sound = sounds.members[i++] as HxlSound;
		 ...
		 * @return	The <code>BitmapData</code> we just created.
		 */
		public static function addBitmap(Graphic:Class, Reverse:Bool=false, Unique:Bool=false, Key:String=null):BitmapData
		{
		 ...
		 */
		public static function get state():HxlState
		{
			return _game._state;
		}
		...
		public static function resetCameras(NewCamera:HxlCamera=null):Void
		{
			...
			while(i < l)
			{
				cam = HxlG.cameras[i++] as HxlCamera;
		 ...
		 */
		public static function flash(Color:UInt=0xffffffff, Duration:Float=1, OnComplete:Function=null, Force:Bool=false):Void
		{
			var i:UInt = 0;
			var l:UInt = HxlG.cameras.length;
			while(i < l)
				(HxlG.cameras[i++] as HxlCamera).flash(Color,Duration,OnComplete,Force);
		}
		 ...
		 * @param	Force		Force the effect to reset.
		 */
		public static function fade(Color:UInt=0xff000000, Duration:Float=1, OnComplete:Function=null, Force:Bool=false):Void
		{
			var i:UInt = 0;
			var l:UInt = HxlG.cameras.length;
			while(i < l)
				(HxlG.cameras[i++] as HxlCamera).fade(Color,Duration,OnComplete,Force);
		}
		 ...
		 */
		public static function shake(Intensity:Float=0.05, Duration:Float=0.5, OnComplete:Function=null, Force:Bool=true, Direction:UInt=0):Void
		{
			var i:UInt = 0;
			var l:UInt = HxlG.cameras.length;
			while(i < l)
				(HxlG.cameras[i++] as HxlCamera).shake(Intensity,Duration,OnComplete,Force,Direction);
		}
		...
		public static function set bgColor(Color:UInt):Void
		{
			...
			var l:UInt = HxlG.cameras.length;
			while(i < l)
				(HxlG.cameras[i++] as HxlCamera).bgColor = Color;
		}
		 ...
		 */
		public static function overlap(ObjectOrGroup1:HxlBasic=null,ObjectOrGroup2:HxlBasic=null,NotifyCallback:Function=null,ProcessCallback:Function=null):Bool
		{
		 ...
		 */
		public static function collide(ObjectOrGroup1:HxlBasic=null, ObjectOrGroup2:HxlBasic=null, NotifyCallback:Function=null):Bool
		{
		 ...
		 */
		public static function getPlugin(ClassType:Class):HxlBasic
		{
			var pluginList:Array = HxlG.plugins;
			var i:UInt = 0;
			var l:UInt = pluginList.length;
		 ...
		 */
		public static function removePluginType(ClassType:Class):Bool
		{
			//Don't add repeats
		...
		public static function reset():Void
		{
			...
			var debugPathDisplay:DebugPathDisplay = HxlG.getPlugin(DebugPathDisplay) as DebugPathDisplay;
		...
		public static function updatePlugins():Void
		{
			...
			while(i < l)
			{
				plugin = pluginList[i++] as HxlBasic;
