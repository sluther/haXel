...
class HxlTimer
{
	 ...
	 */
	public function start(Time:Float=1,Loops:UInt=1,Callback:Dynamic=null):HxlTimer
	{
	 ...
	 */
	public var timeLeft(getTimeLeft, setTimeLeft):Float;
	...
	{
		return cast(HxlG.getPlugin(TimerManager), TimerManager);
	}
