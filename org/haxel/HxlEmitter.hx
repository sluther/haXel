package org.haxel;
	...
	class HxlEmitter extends HxlGroup
	{
		 ...
		 */
		public function makeParticles(Graphics:Class, Quantity:UInt=50, BakedRotations:UInt=16, Multiple:Bool=false, Collide:Float=0.8):HxlEmitter
		{
			maxSize = Quantity;
		...
		{
			var particle:HxlParticle = recycle(HxlParticle) as HxlParticle;
